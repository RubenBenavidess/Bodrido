...
public class InvoiceController {
    ...
    @Operation(summary = "Crear borrador de factura", description = "Crea una nueva factura en estado DRAFT asociada a una orden. Requiere scope: order:update")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Emitir factura", description = "Cambia el estado de una factura de DRAFT a ISSUED y genera la fecha de emisión. Requiere scope: order:update")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Buscar factura por Orden", description = "Obtiene la factura asociada a un ID de orden específico. Requiere scope: order:view")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Listar todas las facturas", description = "Devuelve el historial completo de facturas. Requiere scope: order:view")
    @GetMapping
    @PreAuthorize("hasAuthority('SCOPE_order:view')")
